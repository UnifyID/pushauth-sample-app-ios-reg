...
install_xcframework "${PODS_ROOT}/UnifyID-Core/UnifyID.xcframework" "UnifyID" "framework" "ios-arm64_armv7/UnifyID.framework" "ios-x86_64-simulator/UnifyID.framework"
install_xcframework "${PODS_ROOT}/UnifyID-Core/Clibsodium.xcframework" "Clibsodium" "library" "ios-x86_64-maccatalyst" "ios-arm64_i386_x86_64-simulator" "ios-arm64_armv7_armv7s"
install_xcframework "${PODS_ROOT}/UnifyID-Core/SwiftProtobuf.xcframework" "SwiftProtobuf" "framework" "ios-arm64_armv7/SwiftProtobuf.framework" "ios-arm64_i386_x86_64-simulator/SwiftProtobuf.framework"
