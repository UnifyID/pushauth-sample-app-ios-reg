...
install_xcframework "${PODS_ROOT}/UnifyID-PushAuth/PushAuth.xcframework" "PushAuth" "framework" "ios-x86_64-simulator/PushAuth.framework" "ios-arm64_armv7/PushAuth.framework"
